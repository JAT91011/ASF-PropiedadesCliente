...
public class ClientePropiedades {
	...
	public static void main(String[] args) throws RemoteException {
		...
		// PropiedadesSWStub stub = new
		// PropiedadesSWStub("http://localhost:8080/axis2/services/PropiedadesSW");
		//
		...
		//
		// // Proceso inserci�n municipio Bilbao
		...
		//
		// // Proceso inserci�n municipio Karrantza
		...
		//
		// // Proceso inserci�n municipio Madrid
		...
		//
		// // Proceso inserci�n municipio Vitoria
		...
		// propiedadesMunicipio[i].getNombre() + "\n");
		// }
		//
		...
		// System.out.println("La propiedad " + propiedades[i].getNombre() + "
