                ...
                if (localArgsTracker){
                             if (localArgs!=null) {
                                   ...
                                   for (int i = 0;i < localArgs.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://services", "args", xmlWriter);
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services","args").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://services","args").equals(reader.getName())){
